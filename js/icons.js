/** SVG icons 16×16, stroke currentColor — dùng chung toàn extension */
const S = (paths, size = 16) =>
...
export function iconBtn(iconKey, title, extraClass = '') {
  return `<button type="button" class="btn btn-icon ${extraClass}" title="${title}" aria-label="${title}">${icons[iconKey]}</button>`;
}
